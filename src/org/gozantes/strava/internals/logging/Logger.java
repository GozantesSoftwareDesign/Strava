package org.gozantes.strava.internals.logging;
    ...
    private Logger(String name) {
        ...
        java.util.logging.SimpleFormatter fm = new java.util.logging.SimpleFormatter() {
            ...
            public synchronized String format(LogRecord lr) {
                return String.format("[%s] %s: %s\n", df.format(new Date(lr.getMillis())), lr.getLevel().getName(), lr.getMessage());
            }
        };
        ...
        try {
            ...
            java.util.logging.FileHandler fh = new java.util.logging.FileHandler("log/" + name + new SimpleDateFormat("_dd-MM-YYYY_H-m-s").format(new Date(System.currentTimeMillis())) + ".log");
            fh.setFormatter(fm);
