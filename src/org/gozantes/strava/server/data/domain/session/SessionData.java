...
public record SessionData(String title, Sport sport, BigDecimal distance, Date start, Duration duration) {
    ...
    public SessionData(SessionData data) {
        this(data == null ? null : data.title, data == null ? null : data.sport, data == null ? null : data.distance, data == null ? null : data.start, data == null ? null : data.duration);
    }

    public SessionData(SessionData data, String title) {
        this(title, data == null ? null : data.sport, data == null ? null : data.distance, data == null ? null : data.start, data == null ? null : data.duration);
    }

    public SessionData(SessionData data, Sport sport) {
        this(data == null ? null : data.title, sport, data == null ? null : data.distance, data == null ? null : data.start, data == null ? null : data.duration);
    }

    public SessionData(SessionData data, BigDecimal distance) {
        this(data == null ? null : data.title, data == null ? null : data.sport, distance, data == null ? null : data.start, data == null ? null : data.duration);
    }

    public SessionData(SessionData data, Date start) {
        this(data == null ? null : data.title, data == null ? null : data.sport, data == null ? null : data.distance, start, data == null ? null : data.duration);
    }

    public SessionData(SessionData data, Duration duration) {
        this(data == null ? null : data.title, data == null ? null : data.sport, data == null ? null : data.distance, data == null ? null : data.start, duration);
    }
}
